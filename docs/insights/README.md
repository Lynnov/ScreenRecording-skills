...
| [scripted-browser-video-generator.md](./scripted-browser-video-generator.md) | [handover/scripted-browser-video-generator.md](../handover/scripted-browser-video-generator.md) | 脚本到教程视频：CLI-first、Playwright 分段录制、阿里云 TTS、ffmpeg 合成、后续 Skill/UI 包装 |
| [video-generator-recording-reliability.md](./video-generator-recording-reliability.md) | [handover/video-generator-recording-reliability.md](../handover/video-generator-recording-reliability.md) | 真实业务录制可靠性：Stage 可执行稿、失败诊断包、Playwright 失败可解释性 |
