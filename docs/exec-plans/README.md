...
| active/continuous-video-recording.md | 连续操作视频录制：1920×1080 全脚本连续录制、selector 滚动等待、字幕规范化、Pacdora 可见路径 | 待开始 |
...
| 文件 | 主题 | 完成日期 |
|------|------|----------|
| completed/scripted-browser-video-generator.md | 脚本驱动浏览器教程视频生成器：自然语言脚本 → Playwright 分段录制 → 阿里云 TTS → 字幕 → ffmpeg 合成 | 2026-05-21 |
